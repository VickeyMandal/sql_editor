        ...
        <Suspense fallback={<Loading />}>
          ...
          <div className="text-lg font-semibold ">
            <div className="absolute h-3 w-3 flex items-center  justify-center ">
              <span className="animate-ping absolute inline-flex  left-9 top-2 h-3 w-3 rounded-full bg-blue-500 opacity-75"></span>
              <span className="absolute inline-flex rounded-full  left-9 top-2 z-10  h-3 w-3 bg-blue-500"></span>
           ...
           rounded-full"
            ...
            <div className="h-14 border-b-[1px] border-gray-400 text-white bg-gradient-to-r from-cyan-500 to-blue-500 flex flex-row pl-5 items-center overflow-hidden">
